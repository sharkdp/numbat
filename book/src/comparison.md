...
- [Woxi](https://woxi.ad-si.com) is an interpreter for the [Wolfram Language](https://www.wolfram.com/language/),
  which includes more than 6000 standard functions for scientific work across domains such as
