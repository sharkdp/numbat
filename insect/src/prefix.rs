...
impl Display for Prefix {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Prefix::Decimal(-18) => write!(f, "atto"),
            Prefix::Decimal(-15) => write!(f, "femto"),
            Prefix::Decimal(-12) => write!(f, "pico"),
            Prefix::Decimal(-9) => write!(f, "nano"),
            Prefix::Decimal(-6) => write!(f, "micro"),
            ...
            Prefix::Decimal(9) => write!(f, "giga"),
            Prefix::Decimal(12) => write!(f, "tera"),
